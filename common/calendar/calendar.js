...
Page({
  ...
  submit: function () {
    // console.log(utils.getDay(new Date("2019-"+this.data.bg_date), 4, 1, 3));
    var dateinfo = {
      search_day2: this.data.day2,
      day2: this.data.day2,
      seend_date: this.data.end_date,
      sebg_date: this.data.bg_date,
      seend_date1: this.data.end_date1,
      sebg_date1: this.data.bg_date1,

      end_date: utils.getDay(new Date("2019-" + this.data.bg_date), 4, 1, 3),
      bg_date: utils.getDay(new Date("2019-" + this.data.bg_date), 4, 0, 3),
      end_date1: utils.getDay(new Date("2019-" + this.data.bg_date), 3, 1, 2),
      bg_date1: utils.getDay(new Date("2019-" + this.data.bg_date), 3, 0, 2),
    };
