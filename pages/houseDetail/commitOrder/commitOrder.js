...
Page({
  ...
  formSubmit: function (e) {
    ...
    var data = {
      ...
      houseId: that.data.room_id,
      presentPrice: that.data.dataList.depositMoney,
      orderDeposit: that.data.dataList.orderDeposit
    ...
    wxb.Post(wxb.api.create_order, data, function (data) {
      if (data) {
        ...
        setTimeout(function () {
          Toast.clear();
          wx.navigateTo({
            url: '../../order/pay/pay?order_id=' + data.orderID,
          });
          that.setData({
            isDisabled: false
          });
  ...
  */
  onLoad: function (options) {
    ...
    wxb.Post(wxb.api.house_detail, { houseId: options.room_id }, function (data) {
      console.log(data);
      that.setData({
        dataList: {
          ...
          price1: options.orderDeposit * day + '.00',
          depositMoney: data.presentPrice,
          ...
          room_number: data.Min,
          danjia: data.presentPrice,
